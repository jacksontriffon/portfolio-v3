...
export const AntiqueDivider = () => {
  return (
    <div className="flex flex-1 flex-col gap-0.5">
      <div className="bg-antique-200 h-0.5 w-full"></div>
      <div className="bg-antique-200 h-px w-full"></div>
    </div>
  );
};

export const PathsDrawEffect: React.FC<Props> = ({
  pathLengths,
  title,
  description,
  className,
}) => {
  const colours = ["#B8A39D", "#8C7471", "#6DB96C", "#6C98DA", "#426DAD"];

  return (
    <div className={cn("relative flex h-96 flex-col", className)}>
      <div className="flex flex-col gap-2">
        <h3 className="from-antique-700 to-antique-200 bg-gradient-to-b bg-clip-text text-center text-2xl font-bold text-transparent md:text-4xl">
          {title ?? "Clever designs save weeks."}
        </h3>
        <p className="text-antique-200 mx-auto max-w-lg text-center text-xs font-normal md:text-base">
          {description ?? "I think like a designer and build like an engineer."}
        </p>
      </div>
      <div className="flex justify-center">
        <div className="relative w-full max-w-[1440px]">
          ...
          <svg
            ...
            className="absolute -top-[420px] w-full"
          >
            <motion.path
          ...
          {/* <Button className="bg-antique-900 translate-y-12">
          Scope down by 200%
        </Button> */}
        </div>
      </div>
