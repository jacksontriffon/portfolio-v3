    ...
    >
      ...
      >
        <div
          ...
          className="absolute top-1/2 left-1/2 flex items-start justify-start overflow-hidden rounded-sm border border-white/[0.1] bg-black p-4 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.2]"
        >
      ...
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <p
            // href={href}
            // target={"_blank"}
            className="relative z-10 flex items-center space-x-2 rounded-full bg-white px-4 py-0.5 ring-1 ring-black/10"
          >
            <span className="relative z-20 inline-block py-0.5 text-xs font-bold text-black">
              {title}
            </span>
