    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative flex h-48 w-48 items-center justify-center rounded-full text-3xl font-bold text-white">
            <div className="absolute h-full w-full rounded-full bg-white/[0.8] blur-sm dark:bg-black/[0.8]" />
            <span className="text-antique-700 z-20">{text}</span>
          </div>
        </div>
      </div>
    </div>
